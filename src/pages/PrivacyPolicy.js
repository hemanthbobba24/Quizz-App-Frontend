      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 8, flex: 1 }}>
        ...
        >
          ...
          <Typography variant="body1" paragraph>
            ...
            <Link href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener">
          ...
          <Box component="ul" sx={{ pl: 3, '& li': { mb: 2 } }}>
            ...
            <li>
              <Typography variant="body1">
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Triviaverse.
              </Typography>
            </li>
            <li>
              <Typography variant="body1">
          ...
          <Typography variant="body1" paragraph>
            ...
            <Link href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noopener">
              TermsFeed website
            </Link>{' '}
            article.
          </Typography>
          ...
          <Box component="ul" sx={{ pl: 3, '& li': { mb: 1 } }}>
            <li><Typography variant="body1">Comply with a legal obligation</Typography></li>
            <li><Typography variant="body1">Protect and defend the rights or property of the Company</Typography></li>
            <li><Typography variant="body1">Prevent or investigate possible wrongdoing in connection with the Service</Typography></li>
            <li><Typography variant="body1">Protect the personal safety of Users of the Service or the public</Typography></li>
            <li><Typography variant="body1">Protect against legal liability</Typography></li>
          </Box>
          ...
          <Box component="ul" sx={{ pl: 3, '& li': { mb: 2 } }}>
            <li>
              ...
              <Typography variant="body1">
                ...
                <Link href="https://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noopener">
